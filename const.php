...
<html>
    ...
    <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Construction </h2>
                    <h5 class="section-subheading text-muted">Capture of building </h5>
                </div>
        <div class='container'>
            <div class="gallery">
                ...
                if ($dh = opendir($dir)){
                    ...
                    while (($file = readdir($dh)) !== false){
                        ...
                        if($file != '' && $file != '.' && $file != '..'){
                            ...
                            $thumbnail_path = "cons/".$file;

                            // Image path
                            $image_path = "cons/".$file;
