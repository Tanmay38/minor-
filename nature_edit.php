...
<input type="hidden" name="id" value="<?php echo $row['id']?>">
    ...
    <div class="form-group">
        <label>Photo</label>
        <div class="form-group">
       <input type="file"  accept="image/*" name="image" id="file" value="<?php echo $row['photo']?>" onchange="loadFile(event)" style="display: none;">
...
<div class="modal-footer">
        <a href="nature.php" class="btn btn-danger">Cancel</a>
        <button type="submit" name="natureditbtn" class="btn btn-primary">Save</button>
</div>
</div>
</form>
